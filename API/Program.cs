...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Demo18June", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Demo18JuneContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Demo18June API v1");
